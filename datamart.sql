create view dwh.shipping_datamart as 
select 
si.shippingid,
si.vendorid,
st.transfer_model as transfer_type,
...
from dwh.shipping_info si
join dwh.shipping_status ss on si.shippingid = ss.shippingid
join dwh.shipping_agreement sa on si.agreementid = sa.agreementid
join dwh.shipping_transfer st on si.transfer_type_id = st.transfer_type_id
join dwh.shipping_country_rates scr on si.shipping_country_id = scr.shipping_country_id;
